...
PHP Community Foundation, Inc. ("us", "we", or "our") operates websites,
services, and applications (hereinafter referred to as the "Services").

This page informs you of our policies regarding the collection, use and
disclosure of personal data when you use our Services and the choices
...
Services
   Services means all websites, services, and applications operated by
   PHP Community Foundation, Inc.
...
Data Subject (or User)
   Data Subject is any living individual who is using our Services and
...
and to improve and analyze our Services.
...
For more on cookies, read our `Cookie Policy <cookie_policy.rst>`__.

Use of Data
-----------

PHP Community Foundation, Inc. uses the collected data for various
purposes:
...
If you are from the European Economic Area (EEA), PHP Community
Foundation, Inc. legal basis for collecting and using the personal
...
PHP Community Foundation, Inc. may process your Personal Data because:
...
PHP Community Foundation, Inc. will retain your Personal Data only for
...
PHP Community Foundation, Inc. will also retain Usage Data for internal
...
PHP Community Foundation, Inc. will take all the steps reasonably
...
Under certain circumstances, PHP Community Foundation, Inc. may be
...
PHP Community Foundation, Inc. may disclose your Personal Data in the
good faith belief that such action is necessary to:

-  To comply with a legal obligation
-  To protect and defend the rights or property of PHP Community
   Foundation, Inc.
...
certain data protection rights. PHP Community Foundation, Inc. aims to
...
-  **The right to withdraw consent.** You also have the right to
   withdraw your consent at any time where PHP Community Foundation,
...
perform Services-related services or assist us in analyzing how our
Services are used.
...
-  **BootstrapCDN**
   ...
   BootstrapCDN is a content delivery service for static assets. You can
   visit their Privacy Policy page here:
   https://www.bootstrapcdn.com/privacy-policy/

-  **DigitalOcean**

   DigitalOcean is a Cloud hosting service. You can visit their Privacy
   Policy page here: https://www.digitalocean.com/legal/privacy-policy/

-  **GitHub**

   GitHub is a source code and static website hosting service. You can
   visit their Privacy Policy page here:
   https://help.github.com/en/articles/github-privacy-statement

-  **Masto.host**

   Masto.host is a Mastodon hosting service. You can visit their Privacy
   Policy page here: https://masto.host/privacy/

-  **Netlify**

   Netlify is a web development platform and static website hosting
   service. You can visit their Privacy Policy page here:
   https://www.netlify.com/privacy/

-  **PrivacyPolicies.com**

   PrivacyPolicies.com is a privacy policy and cookie consent hosting
   service. You can visit their Privacy Policy page here:
   https://www.privacypolicies.com/legal/privacy-policy

-  **Rocket.Chat**

   Rocket.Chat provides mobile and desktop apps and a push notification
   gateway for our self-hosted `phpc.chat <https://phpc.chat>`__
   service. You can visit their Privacy Policy page here:
...
by email at legal@phpcommunity.org or by post at:

| PHP Community Foundation, Inc.
| 2500 Murfreesboro Pike
| Suite 105 PMB 358
| Nashville, TN 37217-3629
| United States
